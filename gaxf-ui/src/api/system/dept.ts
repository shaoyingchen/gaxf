...
import type { DeptQueryParams, SysDept, DeptSortParams, AjaxResult, TreeSelect } from '@/types'
...
// 查询部门树结构
export function deptTree(query?: DeptQueryParams): Promise<AjaxResult<TreeSelect[]>> {
  return request({
