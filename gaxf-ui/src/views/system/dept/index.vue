                     ...
                     <template #default="scope">
                        <div class="table-action">
                           <el-tooltip content="修改" placement="top">
                              <button class="action-icon-btn edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:dept:edit']">
                           ...
                           <el-tooltip content="新增" placement="top">
                              <button class="action-icon-btn" @click="handleAdd(scope.row)" v-hasPermi="['system:dept:add']">
                                 <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                           ...
                           <el-tooltip content="删除" placement="top" v-if="scope.row.parentId != 0">
                              <button class="action-icon-btn delete" @click="handleDelete(scope.row)" v-hasPermi="['system:dept:remove']">
                                 <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
