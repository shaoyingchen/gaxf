  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>信访事项交办反馈系统</h2>
        <p>
            信访事项交办反馈系统是面向公安视频督查管理的专业平台，集成视频监控、智能预警、整改跟踪、数据统计等核心功能。系统支持多级部门数据权限控制，实现从预警发现、处置整改、反馈核实到统计分析的全流程闭环管理，助力提升公安视频督查工作效率和规范化水平。
        </p>
        <p>
...
const version = ref<string>('3.9.1')
